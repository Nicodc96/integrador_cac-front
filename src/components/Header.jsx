    ...
    return (
        <header>
                ...
                <div className="container-fluid">
                    ...
                    >
                        <div className="navbar-nav fw-semibold">
                            ...
                            <a className="nav-link" href="#main-grid-info">
                                El lugar y la fecha
                            </a>
                            ...
                            <a
                                className="nav-link nav-tickets"
                                data-bs-toggle="modal"
                                data-bs-target="#staticModalTicket"
                            >
                                Comprar tickets
                            </a>
                        </div>
            ...
            <div className="banner-text">
                ...
                <p id="bannerMainText" className="fs-5">
                    Llega por primera vez a Argentina un evento para compartir
                    con nuestra comunidad el conocimiento y experiencia de los
                    expertos que están creando el futuro de Internet. Ven a
                    conocer a miembros del evento, a otros estudiantes de Codo a
                    Codo y los oradores del primer nivel que tenemos para ti.
                    ¡Te esperamos!
                </p>
                <button
                    type="button"
